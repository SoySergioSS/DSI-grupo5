...
public class JFrame_IniciarSesion extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        background.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 51, 153), 3,true));


        jlblSesion.setFont(new java.awt.Font("Roboto", 1, 18)); // NOI18N
        jlblSesion.setText("INICIAR SESION");
        jlblSesion.setForeground(new java.awt.Color(0, 51, 153));
        background.add(jlblSesion, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 260, -1, -1));

        jLabel2.setText("USUARIO");
        jLabel2.setForeground(new java.awt.Color(0, 51, 153));
        background.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 300, -1, -1));
        ...
        background.add(jtxtUsuario, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 330, 330, 30));
        background.add(jsptrUsuario, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 360, 330, 10));

        jlblContraseña.setText("CONTRASEÑA");
        jlblContraseña.setForeground(new java.awt.Color(0, 51, 153));
        background.add(jlblContraseña, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 380, -1, -1));
        background.add(jSeparator1, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 430, 330, 10));
        ...
        background.add(jtxtContraseña, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 400, 330, 30));

        jbtnEntrar.setBackground(new java.awt.Color(0, 153, 51));
        jbtnEntrar.setFont(new java.awt.Font("Montserrat", 1, 18)); // NOI18N
        jbtnEntrar.setForeground(new java.awt.Color(255, 255, 255));
        jbtnEntrar.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);
        ...
        background.add(jbtnEntrar, new org.netbeans.lib.awtextra.AbsoluteConstraints( (440 - jbtnEntrar.getPreferredSize().width) / 2, 460, -1, -1));
       
        jbtnSalir.setBackground(new java.awt.Color(153,0,0));
        jbtnSalir.setFont(new java.awt.Font("Montserrat", 1, 18)); // NOI18N
        ...
        background.add(jbtnSalir, new org.netbeans.lib.awtextra.AbsoluteConstraints( (440 - jbtnSalir.getPreferredSize().width) / 2, 500, -1, -1));
    ...
    private void jbtnEntrarActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        try {
            ...
            if (adminImpl.Seleccionar(usuario) != -1) {
                ...
                ImageIcon icono = new ImageIcon("src/Imagenes/confirmado-admin.png"); // Ruta de la imagen
                JOptionPane.showMessageDialog(rootPane, "Bienvenido, administrador "+ usuario.getUsuario(), "Inicio de Sesión", JOptionPane.PLAIN_MESSAGE, icono);
//                JOptionPane.showMessageDialog(null, "Bienvenido, administrador " + usuario.getUsuario());
                ...
                if (clientImpl.Seleccionar(usuario) != -1) {
                    ...
                    ImageIcon icono = new ImageIcon("src/Imagenes/confirmado-cliente.gif"); // Ruta de la imagen
                    JOptionPane.showMessageDialog(rootPane, "Bienvenido, " + usuario.getUsuario(), "Inicio de Sesión",JOptionPane.PLAIN_MESSAGE, icono);
