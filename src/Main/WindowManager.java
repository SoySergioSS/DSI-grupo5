...
public class WindowManager {
    ...
    public static int getIdArticulo() {
        return idArticulo;
    }

    public static void setIdArticulo(int idActividad) {
        WindowManager.idArticulo = idActividad;
    }
    ...
    public static void setIdActividad(int idActividad) {
        WindowManager.idActividad = idActividad;
    }
